            ...
            <div>
                <div class="mb-6">
                    <div class="flex justify-between items-center">
                        <h2 class="text-xl font-bold dark:text-white">ปฏิทิน</h2>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <iframe class="w-full h-96 aspect-video"
                        src="https://calendar.google.com/calendar/embed?src=fitm.kmutnb.ac.th_tes1o6gmqkqeo3msestaem06og%40group.calendar.google.com&ctz=Asia%2FBangkok"></iframe>
                </div>
            </div>
    ...
    <div class="max-w-screen-xl mx-auto px-4 py-8 dark:bg-gray-900">
        <div class="mb-10">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-bold dark:text-white">เมนูบริการออนไลน์</h2>
            </div>
        </div>
