...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form id="editForm" method="POST" action="{{ route('contents.update', ['content' => $content->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            <div class="col-md-6">
                ...
                try {
                    const response = await fetch(
                        '{{ route('contents.update', ['content' => $content->id]) }}', {
                            method: 'POST', // Changed from PUT to POST since we're sending form data
                            headers: {
                            ...
                            body: JSON.stringify({
                                _method: 'PUT', // This emulates PUT request for Laravel
