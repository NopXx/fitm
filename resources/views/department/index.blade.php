...
@section('content')
    <div class="max-w-screen-xl mx-auto px-4 py-8 dark:bg-gray-900">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Department</a>
                    </div>
                </li>
        ...
        <div class="mt-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{ $department->department_name_th }}</h1>
        </div>

        <div class="bg-white dark:bg-gray-800 p-6 mt-4">
            <div class="department-content">
                {!! $department->content->overview ?? '' !!}
            </div>
        </div>
    </div>
@endsection
