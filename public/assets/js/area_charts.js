...
colors: [getLocalStorageItem('color-primary','#48BECE')],
  ...
  var chart = new ApexCharts(document.querySelector("#area1"), options);
  chart.render();
...
var options = {
  ...
  colors: ['#7752FE','#78738C','#AECC34','#005E40','#F09E3C'],
  dataLabels: {
    enabled: false
  },
  markers: {
...
colors: ['#AECC34'],
  ...
  var chart = new ApexCharts(document.querySelector("#area3"), options);
  chart.render();
...
colors: ['#AECC34','#F9D249',],
  ...
  var chart = new ApexCharts(document.querySelector("#area4"), options);
  chart.render();
...
colors: ['#48BECE','#48443D',],
  ...
  var chart = new ApexCharts(document.querySelector("#area5"), options);
  chart.render();
...
var ts1 = 1388534400000;
  ...
  var chart = new ApexCharts(document.querySelector("#area7"), options);
  chart.render();
...
var options = {
  ...
  colors: ['#AECC34', '#78738C',getLocalStorageItem('color-primary','#7752FE')],
  dataLabels: {
    enabled: false
  },
  stroke: {
  ...
  xaxis: {
   ...
   colors: ['#AECC34','#8B8476',getLocalStorageItem('color-primary','#48BECE')],
  };

  var chart = new ApexCharts(document.querySelector("#area8"), options);
  chart.render();
